...
const warehouseItems = require('./app/routes/warehouse_item_routes')
const storefrontItems = require('./app/routes/storefront_item_routes')
...
app.use(userRoutes)
app.use(warehouseItems)
app.use(storefrontItems)
